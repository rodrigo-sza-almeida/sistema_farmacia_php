...
<form method = "post" action = "incluir_principioativo_backend.php"><br>
<p>
<td>Codigo:</td> 
<td><input type = "text" name = "idprincipioativo"><br>
<br>
<tr>
<td>Principio Ativo:</td>
<td><input type = "text" name = "principioativo"><br>
<br>
<tr>
