...
<center>
<!--Início Excluir-->
<form method="post" action="excluir_agendamento_backend.php"><br>
<p> <br>
Codigo Agendamento:<select size="1" name="idagendamento">
<?php
...
$data_solicitacao=$registro[1];
echo "<option value=\"$idagendamento\">$idagendamento - $data_solicitacao</option>\n";
}
?>
</select><br><br>
