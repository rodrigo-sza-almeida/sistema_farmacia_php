...
<?php
include "conexao.php";
$result = mysql_query("select * from estoque", $db);
echo "<center><table border='1' id = 'alter'>
<tr class = 'dif'>
	<td><h1>Código Estoque</h1></td>
	<td><h1>Produto</h1></td>
	<td><h1>Quantidade</h1></td>
	<td><h1>Prateleira</h1></td>
	<td><h1>Fila</h1></td>
	<td><h1>Quantidade Máxima</h1></td>
	<td><h1>Quantidade Mínima</h1></td>
	</tr>";
// Escreve resultado até que não haja mais linhas na tabela
while($row = mysql_fetch_array($result)) {
echo "<tr class = 'dif'><td>".$row["idestoque"]."</td>
