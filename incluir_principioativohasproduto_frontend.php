...
<!--Inicio Incluir-->
<center>
<form method = "post" action = "incluir_categoriahasproduto_backend.php"><br>
<p>
...
Codigo Principio Ativo:<select size="1" name="principioativo_idprincipioativo">

<?php
// Gera a lista de principio ativo
error_reporting(0);
$conexao=mysql_connect("127.0.0.1","root","vertrigo");
mysql_select_db("sistema_farmacia_noturno",$conexao);
...
echo "<option value=\"$idprincipioativo\">$principioativo</option>\n";
}
?>
</select><br><br>
