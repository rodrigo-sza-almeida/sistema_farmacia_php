...
<center>
<!--Início Alterar-->
<form method="post" action="alterar_categoria_backend.php"><br>
<p> 
Codigo:<select size="1" name="idcategoria">
<?php
...
{
$idcategoria=$registro[0];
$categoria=$registro[1];
echo "<option value=\"$idcategoria\">$idcategoria - $categoria</option>\n";
}
?>
</select><br><br>
...
<td>Categoria:</td>
<td><input type="text" name="categoria"><br><br>
<tr>
