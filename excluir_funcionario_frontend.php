...
<center>
<!--Início Excluir-->
<form method="post" action="excluir_funcionario_backend.php"><br>
<p> <br>
Codigo Funcionario:<select size="1" name="idfuncionario">
<?php
...
$nome=$registro[1];
echo "<option value=\"$idfuncionario\">$idfuncionario - $nome</option>\n";
}
?>
</select><br><br>
