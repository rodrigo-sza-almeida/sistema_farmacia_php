...
<center>
<!--Início Excluir-->
<form method="post" action="excluir_fabricante_backend.php"><br>
<p> <br>
Codigo Fabricante:<select size="1" name="idfabricante">
<?php
...
$nomecomercial=$registro[1];
echo "<option value=\"$idfabricante\">$idfabricante - $nomecomercial</option>\n";
}
?>
</select><br><br>
